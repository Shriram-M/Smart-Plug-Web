    ...
    <div class="limiter">
      ...
      <center>
        <asp:Panel ID="Panel1" runat="server" Width="703px" BorderStyle="Inset" BorderWidth="4px">
              <asp:Label class="wrap-input100 validate-input" ID="Label1" runat="server" ForeColor="White" Text="MAC ID:"></asp:Label><br /><br />
...
<asp:Button  ID="Button1" runat="server" Text="View Readings"  OnClick="Button1_Click" />
              &nbsp;
